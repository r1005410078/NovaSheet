...
export const denseGridTheme: Theme = {
  ...
  emptyState: {
    ...
    viewBoxHeight: 72,
    layers: [
      { path: 'M18 60a26 4 0 1 0 52 0 26 4 0 1 0-52 0', fill: '#eef1f5' },
      { path: 'M56 48c6-8 12-18 10-28-4 10-8 18-10 28z', fill: '#d4a855' },
      {
        path: 'M30 46c-2-12 6-22 16-24s20 6 22 18c2 12-6 20-16 22s-20-4-22-16z',
        fill: '#e8c478',
        stroke: '#d4a855',
        lineWidth: 1.5,
      },
      { path: 'M40 50c-4-4 2-8 6-6s8 0 10 4c2 4-4 8-10 6s-6-2-6-4z', fill: '#f5deaa' },
      {
        path: 'M27 30a17 17 0 1 0 34 0 17 17 0 1 0-34 0',
        fill: '#e8c478',
        stroke: '#d4a855',
        lineWidth: 1.5,
      },
      { path: 'M28 24c-6-12-12-14-8-4s6 10 8 4z', fill: '#d4a855' },
      { path: 'M60 24c6-12 12-14 8-4s-6 10-8 4z', fill: '#d4a855' },
      { path: 'M44 34c-6 0-10 4-10 8s4 8 10 8 10-4 10-8-4-8-10-8z', fill: '#ffffff' },
      { path: 'M44 38a3.5 2.8 0 1 0 0.01 0z', fill: '#4a3728' },
      { path: 'M35 27a2.8 3.2 0 1 0 0.01 0z', fill: '#24292f' },
      { path: 'M53 27a2.8 3.2 0 1 0 0.01 0z', fill: '#24292f' },
      { path: 'M35.8 25.8a0.9 0.9 0 1 0 0.01 0z', fill: '#ffffff' },
      { path: 'M53.8 25.8a0.9 0.9 0 1 0 0.01 0z', fill: '#ffffff' },
      { path: 'M31 36a2.5 1.8 0 1 0 0.01 0z', fill: '#ffc9c9' },
      { path: 'M57 36a2.5 1.8 0 1 0 0.01 0z', fill: '#ffc9c9' },
      { path: 'M42 44.5a2 1.5 0 1 0 4 0 2 1.5 0 1 0-4 0', fill: '#f48484' },
      {
        path: 'M41 43.5q3 3 6 0',
        stroke: '#8b6914',
        lineWidth: 1.5,
        lineCap: 'round',
      },
