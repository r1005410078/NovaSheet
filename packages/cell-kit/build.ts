/**
 * Build script for @zhiguang/cell-kit. Same artifact shape as core/canvas2d.
 */
...
const EXTERNALS = ['@zhiguang/core', '@zhiguang/canvas2d', '@zhiguang/react', 'react', 'react-dom'] as const
const common = {
