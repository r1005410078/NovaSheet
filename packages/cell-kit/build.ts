/**
 * Build script for @zhiguang/novasheet-cell-kit. Same artifact shape as core/canvas2d.
 */
...
const EXTERNALS = ['@zhiguang/novasheet-core', '@zhiguang/novasheet-canvas2d', '@zhiguang/novasheet-react', 'react', 'react-dom'] as const
const common = {
