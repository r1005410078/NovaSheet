...
export declare const SAFE_MAX = 6000000;
export declare class ScrollMapper {
    /**
     ...
     */
    scrollToLogical(scrollTop: number, spacerSize: number, contentSize: number, viewportSize: number): number;
    /**
     * 反向：logicalY → scrollTop，用于程序化滚动（scrollToRow / scrollToCell）。
     */
    logicalToScroll(logicalY: number, spacerSize: number, contentSize: number, viewportSize: number): number;
}
//# sourceMappingURL=ScrollMapper.d.ts.map