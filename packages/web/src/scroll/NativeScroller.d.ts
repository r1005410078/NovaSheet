...
export declare class NativeScroller {
    private scrollHost;
    private scheduler;
    private onScroll;
    private destroyed;
     ...
     * ```
     */
    constructor(scrollHost: HTMLElement, scheduler: FrameScheduler, onScroll: ScrollListener);
    /**
     * 绑定 scroll 事件监听。
     *
     * @example
...
//# sourceMappingURL=NativeScroller.d.ts.map