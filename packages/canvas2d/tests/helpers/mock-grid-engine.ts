// NOTE: 与 packages/core/tests/helpers/mock-grid-engine.ts 保持同步（测试 helper 不跨包共享）。
...
export function makeMockGridEngine(options: MockGridEngineOptions = {}): GridEngine {
  ...
  const engine = {
    ...
    selectColumnGroup: mock((_groupId: string) => false),
    ...
    viewRangeToRaw: mock((_range: CellRange) => null),
    setValidationRule: mock((..._args: Parameters<GridEngine['setValidationRule']>) => {}),
    clearValidationRule: mock((..._args: Parameters<GridEngine['clearValidationRule']>) => {}),
    validateAll: mock(() => {}),
